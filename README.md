...
go1.20.5 -> 246 MB, go1.20.6 -> 246 MB
-->
...
Tool versions:
   code 1.80.1, go go1.20.6 windows/amd64, mage 1.15.0
...
<dd>
<pre style="font-size:80%;">
<a href="https://golang.org/dl/#stable" rel="external">go1.20.6.windows-amd64.zip</a>        <i>(245 MB)</i>
